...
const authenticate = (
  ...
  return async (req: Request, _res: Response, next: NextFunction) => {
    ...
    try {
      ...
      if (!user) return handleUnauthorized("Unauthorized: Invalid user");
      ...
      if (!roles || !roles.includes(user.role)) {
        return handleUnauthorized("Unauthorized: Invalid Access");
      }
      ...
      if (
        ...
        return handleUnauthorized("Access denied: Invalid role or permission");
      }
